...
public class VaadinV08App {
  ...
  public static class MyUI extends UI implements HasLogger {
    ...
    protected void init(VaadinRequest request) {
      setContent(new LoginComponent().postConstruct());
    }
  }
  ...
  public static void startup() throws ServletException {
    DeploymentInfo servletBuilder
        = Servlets.deployment()
                  .setClassLoader(VaadinV08App.class.getClassLoader())
                  .setContextPath("/")
